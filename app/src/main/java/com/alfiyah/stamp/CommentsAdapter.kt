...
class CommentsAdapter (private val mContext: Context,
                       private val mComment: MutableList<com.alfiyah.stamp.Comment>) : RecyclerView.Adapter<CommentsAdapter.ViewHolder>(){
        ...
        userRef.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    Picasso.get().load(item!!.getImage()).placeholder(R.drawable.ic_profile).into(imageProfile)
